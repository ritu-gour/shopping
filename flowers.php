...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="image/b2.jpg"  class="d-block w-100" alt="..." height="400px" width="400px"
                    style=" opacity: 1;background-size: cover;">
                <div class="carousel-caption d-none d-md-block mt- mb-5">
                    <h1 class="c" style="color: white;">Flowers</h1>
                </div>
            </div>
...
$query = "SELECT * FROM shop WHERE category='Flowers'";
